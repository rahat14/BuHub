...
public class bba_pdf_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bba_pdf_list);

        cse_bar= (ProgressBar)findViewById(R.id.progressbar_BBA) ;

        Toast toast = Toast.makeText(getApplicationContext(), "Wait For The  Loading To End", Toast.LENGTH_LONG);
        toast.show();

        //calling RecyclerView
        mrecyclerView = findViewById(R.id.recyclerView_bba_pdf);
        ...
        mRef = mFirebaseDatabase.getReference("Pdf_db").child("BBA");
