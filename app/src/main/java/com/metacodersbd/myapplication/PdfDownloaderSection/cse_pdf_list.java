...
public class cse_pdf_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cse_pdf_list);

        cse_bar= (ProgressBar)findViewById(R.id.progressbar_CSE) ;

        Toast toast = Toast.makeText(getApplicationContext(), "Wait For The  Loading To End", Toast.LENGTH_LONG);
        toast.show();

        //calling RecyclerView
        mrecyclerView = findViewById(R.id.recyclerView_cse_pdf);
